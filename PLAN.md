...
### Stufe 5 — Nach dem Launch

`AUDIT-2.md`, Abschnitt C hat mehrere ursprünglich als CRITICAL gemeldete Punkte nach kritischer Gegenprüfung heruntergestuft. Am relevantesten: **Der Spielstand geht verloren, wenn das Betriebssystem die App im Hintergrund beendet.** Das ist real, aber der Fix wäre größere Architekturarbeit über alle 17 Minispiele. Kosten/Nutzen sprechen klar für "nach dem Launch".
